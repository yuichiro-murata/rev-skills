...
`design-doc-io-table-check`, `xlsx-db-column-check`, `design-doc-formatting-consistency`, and
...
`_shared/xlsx-excel-com-dump.md`'s "dump once, share the text" section. This does not extend to
the WG-folder-scoped comparison skills (`db-design-cross-consistency`, `cross-function-similarity-check`)
